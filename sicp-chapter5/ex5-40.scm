;; So what I've done here is: added the cte as parameters on the necessary code-generators
;; added an empty compile-time-environment constructor
;; initialized a compile-time-environment

;; made the "lambda-body" generator call the "compile-sequence" with the extended cte
...
(define (empty-compile-time-environment) ;; *** MAIN DIFFERENCE IS HERE ***
	(list '()))

(define compile-time-environment ;; *** MAIN DIFFERENCE IS HERE ***
