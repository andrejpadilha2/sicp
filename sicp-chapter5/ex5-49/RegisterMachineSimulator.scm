...
(define (make-new-machine)
	(let 	((pc (make-register 'pc))
		...
		(let 	((the-ops
			...
			(define (print-reset-instruction-counter)
				(newline)
			...
			(define (dispatch message)
				(cond 	((eq? message 'start)
					...
					((eq? message 'print-instruction-counter) (print-reset-instruction-counter))
					((eq? message 'trace-on) (set! tracing 'on))
					((eq? message 'trace-off) (set! tracing 'off))
